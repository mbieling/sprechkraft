...
struct SettingsView: View {
    /// Wird via SPRECHKRAFTApp injiziert; benoetigt fuer micPermissionDenied-Banner (D-13).
                ...
                if appState?.micPermissionDenied == true {
                    HStack(spacing: DesignTokens.Spacing.sm) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            ...
                            Text("Öffne die Datenschutz-Einstellungen, um SPRECHKRAFT Zugriff zu erteilen.")
                                .font(.system(size: 11))
                    ...
                    HStack(spacing: DesignTokens.Spacing.sm) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            Text("Bedienungshilfen-Zugriff erforderlich")
                                .font(.system(size: 13, weight: .medium))
                                .foregroundStyle(.white)
                            Text("SPRECHKRAFT benötigt Zugriff, um Text direkt einzufügen. Stattdessen wird Clipboard verwendet.")
                                .font(.system(size: 11))
                                .foregroundStyle(.white.opacity(0.9))
                        }
                        Spacer()
