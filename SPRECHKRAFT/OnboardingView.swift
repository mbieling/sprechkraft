    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: DesignTokens.Spacing.md) {
                ...
                Text("Willkommen bei SPRECHKRAFT")
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 32) {
                    ...
                    OnboardingStep(
                        number: "1",
                        title: "Der Hotkey",
                        description: "Halte ⌥⌘R gedrückt, um die Aufnahme zu starten. SPRECHKRAFT hört zu, solange du sprichst (oder die Tasten hältst)."
                    ) {
                        Text("⌥⌘R")
                    ...
                    OnboardingStep(
                        ...
                        description: "Damit SPRECHKRAFT Text direkt in andere Apps einfügen kann, wird eine Berechtigung benötigt."
                    ) {
                        HStack {
            ...
            VStack {
                Divider()
                Button("Mit SPRECHKRAFT starten") {
