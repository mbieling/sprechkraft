...
2. **Settings window title-search is fragile** — The window lookup in `SPRECHKRAFTApp.swift` matches on `.contains("Einstellungen")`, which will silently break if the window title changes.
...
**File:** `SPRECHKRAFT/SPRECHKRAFTApp.swift:60-63`
...
**File:** `SPRECHKRAFT/AppDelegate.swift:19`
...
**File:** `SPRECHKRAFT/SPRECHKRAFTApp.swift:68-69`
...
**File:** `SPRECHKRAFT/AppState.swift:37-39`
...
**File:** `SPRECHKRAFT/SPRECHKRAFT.entitlements`
...
<string>SPRECHKRAFT benötigt das Mikrofon für die Spracherkennung.</string>
```
...
**File:** `SPRECHKRAFT/AppDelegate.swift:134`
...
**File:** `Package.swift:10`, `SPRECHKRAFT.xcodeproj/project.pbxproj`
...
**File:** `SPRECHKRAFTTests/HotkeyTests.swift:18`
