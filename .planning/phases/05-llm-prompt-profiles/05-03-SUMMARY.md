...
dependency_graph:
  ...
  affects: [VoiceScribe/Models, VoiceScribe/Extensions, VoiceScribeTests]
tech_stack:
  added: []
  patterns:
...
`VoiceScribe/Models/PromptProfile.swift` erstellt:
...
- **Files modified:** VoiceScribe/Extensions/KeyboardShortcuts+Names.swift
- **Commit:** 830aad1
...
- **Files modified:** VoiceScribeTests/PromptProfileTests.swift
- **Commit:** 830aad1
...
| Criterion | Status |
|-----------|--------|
| VoiceScribe/Models/PromptProfile.swift existiert | PASS |
...
- VoiceScribe/Models/PromptProfile.swift: FOUND
- VoiceScribe/Extensions/Defaults+Keys.swift (profiles Key): FOUND
- VoiceScribe/Extensions/KeyboardShortcuts+Names.swift (profile func): FOUND
